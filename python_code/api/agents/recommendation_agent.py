...
class RecommendationAgent():
    ...
    def get_popular_recommendation(self,product_categories=None,top_k=5):
        ...
        if product_categories is not None:
            ...
            recommendation_df = recommendation_df.sort_values('number_of_transaction',ascending=False)
    ...
    def get_response(self,messages):
        ...
        if recommendations == []:
            return {"role":"assistant", "content":"Sorry, I can't help with this recommendation. Can I help you with something else"}
