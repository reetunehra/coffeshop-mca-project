      ...
      <View className="h-full flex-col justify-between">
        <View className="h-[80%]">
          <ProductList
            ...
            setQuantaties={setQuantityCart}
            totalPrice={totalPrice}
          />
        </View>

        <View className="bg-white rounded-tl-3xl rounded-tr-3xl px-7 pt-3 pb-20">
          ...
          <TouchableOpacity
            ...
            } h-[25%] rounded-2xl items-center justify-center mt-6 py-3`}
            disabled={totalPrice === 0}
            onPress={orderNow}
          >
            <Text className="text-2xl text-white font-[Sora-SemiBold]">
              Order
            </Text>
          </TouchableOpacity>
        </View>
